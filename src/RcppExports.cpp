...
RcppExport SEXP _mpsBART9_log_dmvn(SEXP xSEXP, SEXP SigmaSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _mpsBART9_sum_exclude_col(SEXP matSEXP, SEXP exclude_intSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _mpsBART9_bspline(SEXP xSEXP, SEXP x_obsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type x(xSEXP);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type dif_order(dif_orderSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(sbart(x_train, y_train, x_test, B_train, B_test, D, dif_order, n_tree, node_min_size, n_mcmc, n_burn, tau, mu, tau_mu, tau_b, tau_b_intercept, alpha, beta, a_tau, d_tau, nu, delta, a_delta, d_delta, a_tau_b, d_tau_b, p_sample, p_sample_levels, intercept_model, stump));
    return rcpp_result_gen;
END_RCPP
}
// mat_init
arma::mat mat_init(int n);
RcppExport SEXP _mpsBART9_mat_init(SEXP nSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _mpsBART9_vec_init(SEXP nSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type n(nSEXP);
...
RcppExport SEXP _mpsBART9_std_inv(SEXP ASEXP, SEXP diagSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _mpsBART9_std_pinv(SEXP ASEXP, SEXP diagSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type A(ASEXP);
...
RcppExport SEXP _mpsBART9_faster_simple_std_inv(SEXP ASEXP, SEXP diagSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type A(ASEXP);
...
RcppExport SEXP _mpsBART9_faster_std_inv(SEXP ASEXP, SEXP diagSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type A(ASEXP);
...
RcppExport SEXP _mpsBART9_rMVN2(SEXP bSEXP, SEXP QSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _mpsBART9_rMVNslow(SEXP bSEXP, SEXP QSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::vec& >::type b(bSEXP);
...
RcppExport SEXP _mpsBART9_matrix_mat(SEXP arraySEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_mpsBART9_log_dmvn", (DL_FUNC) &_mpsBART9_log_dmvn, 2},
    {"_mpsBART9_sum_exclude_col", (DL_FUNC) &_mpsBART9_sum_exclude_col, 2},
    {"_mpsBART9_bspline", (DL_FUNC) &_mpsBART9_bspline, 2},
    {"_mpsBART9_sbart", (DL_FUNC) &_mpsBART9_sbart, 30},
    {"_mpsBART9_mat_init", (DL_FUNC) &_mpsBART9_mat_init, 1},
    {"_mpsBART9_vec_init", (DL_FUNC) &_mpsBART9_vec_init, 1},
    {"_mpsBART9_std_inv", (DL_FUNC) &_mpsBART9_std_inv, 2},
    {"_mpsBART9_std_pinv", (DL_FUNC) &_mpsBART9_std_pinv, 2},
    {"_mpsBART9_faster_simple_std_inv", (DL_FUNC) &_mpsBART9_faster_simple_std_inv, 2},
    {"_mpsBART9_faster_std_inv", (DL_FUNC) &_mpsBART9_faster_std_inv, 2},
    {"_mpsBART9_rMVN2", (DL_FUNC) &_mpsBART9_rMVN2, 2},
    {"_mpsBART9_rMVNslow", (DL_FUNC) &_mpsBART9_rMVNslow, 2},
    {"_mpsBART9_matrix_mat", (DL_FUNC) &_mpsBART9_matrix_mat, 1},
    {NULL, NULL, 0}
};

RcppExport void R_init_mpsBART9(DllInfo *dll) {
